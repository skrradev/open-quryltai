...
public class StatisticsService {
    ...
    public List<kz.quryltai.backend.dto.PartyYouthStatsDto> youthStatistics() {
        return repository.youthStatistics(localization.currentLanguage());
    }

    public List<kz.quryltai.backend.dto.PartyGenderStatsDto> genderStatistics() {
        return repository.genderStatistics(localization.currentLanguage());
    }

    public List<PartyCadreStatsDto> cadreStatistics() {
        return repository.cadreStatistics(localization.currentLanguage());
    }

    public List<PartyGeographyStatsDto> geographyStatistics() {
        return repository.geographyStatistics(localization.currentLanguage());
    }
